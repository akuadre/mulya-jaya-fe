...
import {
  ...
  Truck,
  Database,
} from "lucide-react"; // 1. Impor ikon Database
...
const Dashboard = () => {
  ...
  const { showNotification, notification, dismissNotification } =
    useNotification();
  ...
  return (
    <>
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="space-y-8 w-full min-w-0 p-2"
      >
        <motion.h1
          variants={itemVariants}
          className="text-3xl lg:text-4xl font-bold text-gray-800 tracking-tight"
        >
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-gray-500 mt-1 text-sm">
                Unduh salinan data database Anda untuk tujuan keamanan.
              </p>
            </div>
            <button
